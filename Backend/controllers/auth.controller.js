...
const register = async(req, res) => {
    ...
    const user = await User.create({ name, email, password, phone, role, verificationToken });
...
const login = async (req, res) => {
    ...
    if(!user.isVerified) {
        throw new customErrors.UnauthenticatedError("Your account has not been verified yet");
    }
